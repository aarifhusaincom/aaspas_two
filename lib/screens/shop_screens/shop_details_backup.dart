...
//     print("//////////////////////////// load new method runs");
//     print("//////////////////////////// Current shop id is");
//     print(currentShopId);
...
//     print(currentShopId);
//     final url = '${AaspasWizard.baseUrl}${AaspasWizard.getShopsCatItems}$paramString';
//     /////////////////////////////////////
//
...
//     /////////////////////////////////////
//     print("////////currentShopId in fetchShopDetailsById()");
//     print(currentShopId);
//     final response = await http.get(Uri.parse(url));
//
//     if (response.statusCode == 200) {
//       final jsonData = json.decode(response.body);
//
//       ///--- Using ShopDetailsModel Start-----///
//       final model = ShopDetailsModel.fromJson(jsonData);
//       final newItems = model.items! ?? [];
//       setState(() {
//         if (newItems.isEmpty && shopDetails.isEmpty) {
//           noDataFound = true;
//         } else {
//           shopDetails.addAll(newItems);
//         }
//       });
//
//       ///--- Using ShopDetailsModel End-----///
//
//       // print(jsonData);
//       ///--- Using Vanilla JSON Start-----///
//       shopImages = shopDetails.first.shopImages ?? [];
//       // print("///////////////////////////////////////////shopImages");
//       // print(shopImages);
//       shopName = shopDetails.first.shopName;
//       address = shopDetails.first.address;
//       lat = shopDetails.first.location!.coordinates![1];
//       long = shopDetails.first.location!.coordinates![0];
//       area = shopDetails.first.area;
//       // TODO: Handle video. and remove the default link
//       video =
//           shopDetails.first.video ??
//               'https://github.com/aarifhusainwork/aaspas-storage-assets/raw/refs/heads/main/IndoreInstagram/other_reels/reels/1.mp4';
//       phoneNo =
//       (shopDetails.first.phoneNo == null)
//           ? '8884446009'
//           : shopDetails.first.phoneNo.toString();
//       openTime = shopDetails.first.openTime;
//       closeTime = shopDetails.first.closeTime;
//       pinCode = shopDetails.first.pincode;
//       shopNo = shopDetails.first.shopNo;
//       showPhoneNumber = shopDetails.first.showPhoneNumber;
//       verified = shopDetails.first.verified;
//       showItemType = shopDetails.first.showItemType;
//       active = shopDetails.first.active ?? 0;
//       distanceKm = shopDetails.first.distanceKm;
//       workingDays = shopDetails.first.workingDays ?? [];
//       featuredCategories = shopDetails.first.featuredCategories ?? [];
//
...
//       } else {
//         newImageLinks = [];
//         newImageLinks = shopImages;
//
//         ///--- Using Vanilla JSON Ends-----///
//         setState(() {
//           LocationSetterAaspas.getLocation();
//           // print(dataLoaded);
//           dataLoaded = true;
