...
class SearchPageShopWise extends StatelessWidget {
  const SearchPageShopWise({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   ),
      // ),
      appBar: AppbarOnlyBack(title: "Shop Categories"),
      // body: ServicesListNonSliver(),
      body: CustomScrollView(
        slivers: [
          AaspasSearchBar(isEnabled: false),
          SliverToBoxAdapter(
            child: CategoryGridView(categoryType: 'shops', categoriesCount: 0),
          ),
        ],
      ),
    );
